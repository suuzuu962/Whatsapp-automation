i also wanted to have flow of something like this Incoming message
        ↓
...
This is much better than your current proposed <<BOOKING>> text tags.  check if is present or some additional integration can be done or not if it isnt necessary or not matching the goal then ignore it
